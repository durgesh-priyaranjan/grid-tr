...
},{}],"javascripts/eventNames.js":[function(require,module,exports) {
exports.constants = {
  fieldsConfigChange: "FIELD_CONFIG_CHANGED",
  tableConfigChanged: "TABLE_CONFIG_CHANGED"
};
...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"javascripts/services/fields.js":[function(require,module,exports) {
"use strict";
...
var fieldsURI = "http://localhost:3000/data/fields.json";

exports.getFields = function () {
  return _axios.default.get(fieldsURI);
};
},{"axios":"../node_modules/axios/index.js"}],"javascripts/views/fields.js":[function(require,module,exports) {
"use strict";
...
var _fields = require("../services/fields");
...
var qsa = document.querySelectorAll.bind(document); // Render fields selector

var fieldsContainer = qs("#fieldsContainer");
var checkboxSelector = 'input[type="checkbox"]';
var event = new Event(_eventNames.constants.fieldsConfigChange);

function fieldsMarkup(field) {
  return "\n        <div class=\"col-md field-item\" draggable=\"true\">\n            <input class=\"form-check-input\" type=\"checkbox\" checked value=\"\" id=\"".concat(field.name, "\" label=\"").concat(field.label, "\" data-cansearchon=\"").concat(field.canSearchOn, "\" data-cansorton=\"").concat(field.canSortOn, "\" data-cangroupon=\"").concat(field.canGroupOn, "\">\n            <label class=\"form-check-label\" for=\"").concat(field.name, "\">").concat(field.label, "</label>\n        </div>\n    ");
}
...
function bindEvents() {
  fieldsContainer.querySelectorAll(".field-item").forEach(function (el) {
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return (0, _fields.getFields)();

        case 3:
          fields = _context.sent;
          html = fields.data.fields.reduce(function (acc, val) {
...
exports.getFieldsDetails = function () {
  return Array.from(fieldsContainer.querySelectorAll(checkboxSelector)).reduce(function (acc, element) {
    if (element.checked) acc.push({
      id: element.id,
...
},{"@babel/runtime/regenerator":"../node_modules/@babel/runtime/regenerator/index.js","@babel/runtime/helpers/asyncToGenerator":"../node_modules/@babel/runtime/helpers/asyncToGenerator.js","../services/fields":"javascripts/services/fields.js","../eventNames":"javascripts/eventNames.js"}],"javascripts/services/table.js":[function(require,module,exports) {
"use strict";
...
// TODO: frame the uri from location
var fieldsURI = "http://localhost:3000/games";

exports.getData = function (pageNumber, sortBy, sortType, groupBy, searchField, searchText, fieldsSeq) {
  var queryString = "?";

  if (pageNumber && pageNumber > -1) {
    queryString += "pageNumber=".concat(pageNumber, "&");
  }

  if (sortBy) {
    queryString += "sortBy=".concat(sortBy, "&");
  }

  if (sortType) {
    queryString += "sortType=".concat(sortType, "&");
  }

  if (groupBy) {
    queryString += "groupBy=".concat(groupBy.join(","), "&");
  }

  if (searchField && searchText) {
    queryString += "searchField=".concat(searchField, "&");
    queryString += "searchText=".concat(searchText, "&");
  }

  if (fieldsSeq) {
    queryString += "fieldsSeq=".concat(fieldsSeq);
  }

  return _axios.default.get("".concat(fieldsURI).concat(queryString));
};
},{"axios":"../node_modules/axios/index.js"}],"../node_modules/@babel/runtime/helpers/arrayWithoutHoles.js":[function(require,module,exports) {
...
},{"./arrayWithoutHoles":"../node_modules/@babel/runtime/helpers/arrayWithoutHoles.js","./iterableToArray":"../node_modules/@babel/runtime/helpers/iterableToArray.js","./nonIterableSpread":"../node_modules/@babel/runtime/helpers/nonIterableSpread.js"}],"../node_modules/base64-js/index.js":[function(require,module,exports) {
'use strict'
...
},{"buffer":"../node_modules/buffer/index.js"}],"javascripts/views/grouped.js":[function(require,module,exports) {
"use strict";
...
var modalInstance = document.querySelector("#modalCenter");
...
exports.renderGrouped = function (head, data) {
  var groupBy = _table.tableState.aggregateBy;
  ...
  function getNestedMarkup(pointer, key) {
    if (Array.isArray(pointer)) {
      ...
      keys.forEach(function (k) {
        var data = getNestedMarkup(pointer[k], k);
        _html += "<tr key=\"".concat(k, "\">");
        _html += "<td rowspan=\"".concat(data.count + 1, "\"> ").concat(k, " </td>");
        _html += "</tr>";
        _html += data.html;
      });
      return _html;
...
function showUserSummary(data, key) {
  gkey = key;
  gdata = data;
  var games = data.map(function (i) {
    return i["game"];
  });
  var difficultyLevel = data.map(function (i) {
    return i["difficultyLevel"];
  });
  var scores = data.map(function (i) {
    return i["score"];
  });
  var lowestScore = Math.min.apply(Math, (0, _toConsumableArray2.default)(scores));
  var highestScore = Math.max.apply(Math, (0, _toConsumableArray2.default)(scores));
  gconf.game = (0, _lodash.uniq)(games);
  gconf.difficultyLevel = (0, _lodash.uniq)(difficultyLevel);
  gconf.score = (0, _lodash.uniq)(scores);
  var html = "\n        <dl>\n            <dt>User: ".concat(key, "</dt>\n            <dd>Played Games: ").concat(games.join(", "), "</dd>\n            <dd>At levels: ").concat(difficultyLevel.join(", "), "</dd>\n            <dd>Scores: ").concat(scores.join(", "), "</dd>\n            <dd>Lowest Score: ").concat(lowestScore, "</dd>\n            <dd>Highest Score: ").concat(highestScore, "</dd>\n        </dl>\n    ");
  ...
  modalInstance.querySelector(".modal-body .custom-select.x").innerHTML = userSelectX;
  modalInstance.querySelector(".modal-body .custom-select.y").innerHTML = userSelectY;
  $(modalInstance).modal();
}
...
$(modalInstance).on("shown.bs.modal", function (e) {
  ...
  keys.forEach(function (k) {
    var chart = new ApexCharts(document.querySelector(".total-".concat(k)), {
      chart: {
        type: "donut"
      },
      series: gconf[k].map(function (i) {
        return 100 / gconf[k].length;
      }),
      dataLabels: {
        enabled: true,
        formatter: function formatter(val, options) {
...
function customChart(key, data, conf) {
  var xAxis = document.querySelector(".custom-select.x").value;
  var yAxis = document.querySelector(".custom-select.y").value;
  var yData = [];
  var xData = [];
...
exports.showSummary = function (key) {
  if (_table.tableState.aggregateBy[0] === "username") {
    showUserSummary(_table.tableState.data[key], key);
  }

  if (_table.tableState.aggregateBy[0] === "game") {
    showUserSummary(_table.tableState.data[key], key);
  }
};
},{"@babel/runtime/helpers/toConsumableArray":"../node_modules/@babel/runtime/helpers/toConsumableArray.js","./table":"javascripts/views/table.js","lodash":"../node_modules/lodash/lodash.js"}],"javascripts/views/table.js":[function(require,module,exports) {
"use strict";
...
var _table = require("../services/table");
...
var event = new Event(_eventNames.constants.tableConfigChanged);
var tableContainer = qs("#tableContainer > table");
var paginationContainer = qs("#tableContainer > .pagination");
var state = {
  totalPage: 1,
  _pageNumber: 1,
...
function headMarkup(fields) {
  var th = fields.reduce(function (acc, f) {
    acc += "<th name=\"".concat(f.id, "\">").concat(f.label, " <br/>");
    ...
    if (f.canSortOn) {
      acc += "<button class=\"btn btn-sm btn-outline-secondary sort ".concat(isDesc ? "active" : "", "\" type=\"desc\">\u2193</button>");
      acc += "<button class=\"btn btn-sm btn-outline-secondary sort ".concat(isAsc ? "active" : "", "\" type=\"asc\">\u2191</button>");
    }
    ...
    if (f.canGroupOn && f.id === fields[0].id) {
      ...
      acc += "<button class=\"btn btn-sm btn-outline-secondary group ".concat(isActive ? "active" : "", "\">+</button>");
    }

    if (f.canSearchOn) {
      var val = state.searchField === f.id ? state.searchText : "";
      acc += "<input type=\"text\" value=\"".concat(val, "\">");
    }
...
function bodyMarkUp(bodyData) {
  ...
  var body = "";
  return "<tbody>".concat(body, "</tbody>");
}

function buildRows(headData, tableData) {
  var columnNames = headData.map(function (i) {
    return i.id;
  });
  var rows = "";
  tableData.forEach(function (d) {
    var columns = headData.reduce(function (acc, curr) {
      acc += "<td>".concat(d[curr.id], "</td>");
      return acc;
    }, "");
    rows += "\n            <tr>".concat(columns, "</tr>\n        ");
  });
  return rows;
}
...
function renderPaginator() {
  ...
  if (state.pageNumber > 1) {
    html += "<li class=\"page-item\">\n              <a class=\"page-link\" href=\"#\" data-page=\"".concat(state.pageNumber - 1, "\"><</a>\n          </li>");
  } else {
    html += "<li class=\"page-item disabled\">\n              <a class=\"page-link\" href=\"#\" data-page=\"".concat(state.pageNumber - 1, "\"><</a>\n          </li>");
  }

  html += "<li class=\"page-item active\">\n              <a class=\"page-link\" href=\"#\" data-page=\"".concat(state.pageNumber, "\">").concat(state.pageNumber, "</a>\n          </li>");

  if (state.pageNumber < state.totalPage) {
    html += "<li class=\"page-item\">\n          <a class=\"page-link\" href=\"#\" data-page=\"".concat(state.pageNumber + 1, "\">></a>\n      </li>\n      <li class=\"page-item\">\n          <a class=\"page-link\" href=\"#\" data-page=\"").concat(state.totalPage, "\">>></a>\n      </li>");
  } else {
...
function fetchAndRenderBody(_x, _x2) {
  return _fetchAndRenderBody.apply(this, arguments);
}

function _fetchAndRenderBody() {
  _fetchAndRenderBody = (0, _asyncToGenerator2.default)(
  /*#__PURE__*/
  _regenerator.default.mark(function _callee(headData, headHTML) {
    var _ref,
        _ref$pageNumber,
        pageNumber,
        sortBy,
    ...
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _ref = _args.length > 2 && _args[2] !== undefined ? _args[2] : {}, _ref$pageNumber = _ref.pageNumber, pageNumber = _ref$pageNumber === void 0 ? 1 : _ref$pageNumber, sortBy = _ref.sortBy, _ref$sortType = _ref.sortType, sortType = _ref$sortType === void 0 ? "asc" : _ref$sortType, aggregateBy = _ref.aggregateBy, searchField = _ref.searchField, searchText = _ref.searchText;
            fieldsSeq = _args.length > 3 ? _args[3] : undefined;
            _context.next = 4;
            return (0, _table.getData)(pageNumber, sortBy, sortType, aggregateBy, searchField, searchText, fieldsSeq);
          ...
          case 4:
            ...
            if (Array.isArray(data.data.data)) {
              ...
              bodyMarkup = (0, _grouped.renderGrouped)(headData, data.data.data);
            }
...
exports.renderTable = function (headData, pageConfig, fieldsSeq) {
  var headHTML = headMarkup(headData);
  tableContainer.innerHTML = headHTML + bodyMarkUp();
...
(function init() {
  ...
  tableContainer.addEventListener("click", function (e) {
    ...
    if (target.classList.contains("sort")) {
      var col = target.closest("th").getAttribute("name");
      var sortType = target.getAttribute("type");
      state.sortType = sortType;
      state.sortBy = col;
    }

    if (target.classList.contains("group")) {
      var _col = target.closest("th").getAttribute("name");

      state.aggregateBy = _col;
    }

    if (target.closest("tr")) {
      var row = target.closest("tr");
      var key = row.getAttribute("key");
      if (key) (0, _grouped.showSummary)(key);
    }
  });
...
},{"@babel/runtime/regenerator":"../node_modules/@babel/runtime/regenerator/index.js","@babel/runtime/helpers/asyncToGenerator":"../node_modules/@babel/runtime/helpers/asyncToGenerator.js","../services/table":"javascripts/services/table.js","../eventNames":"javascripts/eventNames.js","./grouped":"javascripts/views/grouped.js"}],"javascripts/index.js":[function(require,module,exports) {
"use strict";
